...
* **1.0.31** - *2017-04-06*
    ...
    + Resolved [issue [#2](https://github.com/eppz/VSCode.Extension.eppz_Code/issues/2)](https://github.com/eppz/VSCode.Extension.eppz_Code/issues/2) that prevented C# extension to load IntelliSense properly
